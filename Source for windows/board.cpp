    ...
    variantSquares()
{
    ...
    lcdSeconds->setGeometry(QRect((int)(1070*k),(int)(60*p), (int)(70*k),(int)(50*p)));
    lcdMinutes->setGeometry(QRect((int)(1000*k),(int)(60*p), (int)(70*k),(int)(50*p)));
...
void Board::paintEvent(QPaintEvent *pe)
{
    ...
    if(Game::mode != -1)
    {
        ...
        else if(Game::movePlayer == 1)
        {
            ...
            p.drawImage(desktop.geometry(),QImage(path+"/image/wallpaper.png"));
