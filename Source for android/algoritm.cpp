...
{
    QFile file(":/MyFiles/system/squares.txt");
    QTextStream fileStream;
    fileStream.setDevice(&file);
    //QString path = ":/MyFiles";
    //string ss = path.toStdString() + "/system/squares.txt";
    ...
    int width = rec.width();
    double k = height / 768.0;
    double p = width / 1366.0;
    ...
    file.close();
    QFile file1(":/MyFiles/system/coord1200700120120600520.txt");
    QTextStream fileStream1;
    fileStream1.setDevice(&file1);
    //file.setFileName(":/MyFiles/system/coord1200700120120600520.txt");
    //ss = path.toStdString() + "/system/coord1200700120120600520.txt";
    ...
    if(file1.isOpen())
    {
        ...
        while(num < 96)
        {
            for(int i = 0; i < 4; i++)
            {
                ...
                sq[num] -> setCoord((int)(x1 *k), (int)(y1*k));
            }
